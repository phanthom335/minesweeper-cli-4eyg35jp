    """
    Minesweeper Cli 4eyg35jp
    ========================
    Open-source Python game project showcasing how to complete classic mechanics.
    ...
    APP_NAME    = "Minesweeper Cli 4eyg35jp"
    APP_VERSION = "1.0.0"
...
return {"score": score, "rounds": guessed_in, "won": score > 0}
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source Python game project showcasing how to complete classic mechanics.")
